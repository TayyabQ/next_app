    ...
    <>
      <div className="relative flex flex-col sm:min-h-screen min-h-150 w-full bg-gradient-to-r from-[#60A5FA] to-[#3B82F6] overflow-hidden shadow-2xl">
        <div className="flex-grow flex flex-col justify-center items-center p-6 sm:p-8 text-center z-10">
          ...
          <h1 className="font-semibold text-3xl xl:text-4xl text-white ">Join Our Newsletter</h1>
          <p className="text-lg xl:text-xl text-neutral-100 mb-5">Stay updated with our latest news and offers!</p>
          <button onClick={handleSubscribeClick} className="text-blue-500 bg-white py-1 lg:py-2 px-2 lg:px-4 lg:text-xl text-lg xl:text-2xl font-semibold rounded-lg hover:cursor-pointer">Subscribe</button>
        </div>
