...
export default function ContactModal({showModal,
  setShowModal,
}: {
  showModal:boolean,
    ...
    <div className="fixed inset-0 backdrop-blur-sm overflow-y-auto h-full w-full flex items-center justify-center animate z-100">
      <div className="w-96 sm:w-150 rounded-md bg-gray-50 shadow-lg">
        ...
        <Modal isOpen={showModal} onClose={()=>{setShowModal(false)}}>
          <h3 className="text-2xl font-bold text-center text-green-600">Contact Us</h3>
          <form
          ...
          >
            ...
            <input
              ...
              id="name"
              type="text"
              className="bg-white px-2 py-1 text-base rounded-md shadow-lg border-1 border-green-500 w-70 sm:w-full h-10 sm:h-12 my-1 sm:my-2 ml-1 sm:ml-2 focus:outline-none text-black focus:border-1 focus:border-green-600"
            ...
            <input
              ...
              id="email"
              type="email"
              className="bg-white px-2 py-1 text-base rounded-md text-black shadow-lg border-1 border-green-500 w-70 sm:w-full h-10 sm:h-12 my-1 sm:my-2 ml-1 sm:ml-2 focus:outline-none focus:border-1 focus:border-green-600"
            ...
            <textarea
              ...
              id="message"
              rows={4}
              className="resize-none bg-white p-2 text-base rounded-md shadow-sm text-blalg border-1 border-green-500 w-70 sm:w-full h-fit my-1 sm:my-2 ml-1 sm:ml-2 focus:outline-none focus:border-1 focus:border-green-600"
